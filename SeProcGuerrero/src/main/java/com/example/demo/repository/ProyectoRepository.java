...
public interface ProyectoRepository extends JpaRepository<Proyecto, Integer> {
    ...
    // Busca el proyecto de una solicitud específica asegurando que pertenezca a la institución
    Optional<Proyecto> findByInstitucionAndSolicitud_IdSolicitud(Institucion institucion, Integer idSolicitud);

    // Lista proyectos filtrados por estado (ej. "ACTIVO") ordenados por fecha, DENTRO de la institución
    List<Proyecto> findByInstitucionAndEstadoProyectoOrderByFechaAprobacionDesc(
            Institucion institucion, String estadoProyecto
    );

    // Lista proyectos asignados a un SUPERVISOR específico, filtrados por estado, DENTRO de la institución
    ...
    // Lista proyectos de un CONTRATISTA específico, filtrados por estado, DENTRO de la institución
