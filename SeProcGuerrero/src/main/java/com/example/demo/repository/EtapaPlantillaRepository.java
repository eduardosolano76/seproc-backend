...
public interface EtapaPlantillaRepository extends JpaRepository<EtapaPlantilla, Long> {
	...
	List<EtapaPlantilla> findByInstitucionAndEtapaPadre_IdEtapaPlantillaOrderByOrdenVisualAsc(Institucion institucion,
			Long idEtapaPadre);

	// Busca una etapa por su clave interna DENTRO de la institución
	Optional<EtapaPlantilla> findByInstitucionAndClaveInterna(Institucion institucion, String claveInterna);
